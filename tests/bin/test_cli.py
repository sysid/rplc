...
def test_cli_swap_in(test_project: tuple[Path, Path], test_config_file: Path, tmp_path: Path) -> None:
...
def test_cli_swap_out(test_project: tuple[Path, Path], test_config_file: Path, tmp_path: Path) -> None:
    proj_dir, mirror_dir = test_project
    runner = CliRunner()
